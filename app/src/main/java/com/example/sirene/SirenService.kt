...
class SirenService {
    ...
    fun query(query: String, per_page: Int, zip_code: String, departement: String, callback : Callback<Results>) {
        ...
        val call: Call<Results> = api.search(query, per_page, zip_code, departement)
